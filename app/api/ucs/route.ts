...
import { ucsSearchDay }                       from "@/lib/algorithms_ucs";
import { formulaHash, haversineDistance, weightedScore, cosineSimilarity } from "@/lib/Algorithms";
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const scoredItems = indexedItems.map(item => {
      ...
      const grandTotalEst = estimateTotalCost(item, distance, totalDays); 
